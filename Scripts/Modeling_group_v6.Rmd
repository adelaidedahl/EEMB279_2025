...
##change this later to run second simu
```{r}
# create a vector of timesteps
tset1 <- seq(from = 0, to = 1000, length.out = 10005)
...
#NEXT STEPS:
###update simu above for structure retaining vs removing
###pick param to change (macro growth rate) and re-run each simu with new growth of macroalgae
